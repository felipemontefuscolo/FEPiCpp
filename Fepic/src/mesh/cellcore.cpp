...
template<typename CellT>
int _CellCore<CellT>::isFacet(int const* vtcs) const
{
  int facet_vtcs[CellT::n_vertices_per_facet];

  for (int f = 0; f < CellT::n_facets; ++f)
  {
